...
type RekeyTrigger struct {
	...
	// PQPublicKey used in the rekey
	PqPublicKey []byte `protobuf:"bytes,2,opt,name=pqPublicKey,proto3" json:"pqPublicKey,omitempty"`
...
func (x *RekeyTrigger) GetPqPublicKey() []byte {
	if x != nil {
...
type RekeyTriggerLegacySIDH struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RekeyTriggerLegacySIDH) Reset() {
	*x = RekeyTriggerLegacySIDH{}
	if protoimpl.UnsafeEnabled {
...
func (x *RekeyTriggerLegacySIDH) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RekeyTriggerLegacySIDH) ProtoMessage() {}

func (x *RekeyTriggerLegacySIDH) ProtoReflect() protoreflect.Message {
	mi := &file_xchange_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RekeyTriggerLegacySIDH.ProtoReflect.Descriptor instead.
func (*RekeyTriggerLegacySIDH) Descriptor() ([]byte, []int) {
	return file_xchange_proto_rawDescGZIP(), []int{1}
}

func (x *RekeyTriggerLegacySIDH) GetPublicKey() []byte {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *RekeyTriggerLegacySIDH) GetSidhPublicKey() []byte {
	if x != nil {
...
func (x *RekeyTriggerLegacySIDH) GetSessionID() []byte {
	if x != nil {
		return x.SessionID
	}
	return nil
...
var file_xchange_proto_rawDesc = []byte{
	...
	0x05, 0x72, 0x65, 0x6b, 0x65, 0x79, 0x22, 0x6c, 0x0a, 0x0c, 0x52, 0x65, 0x6b, 0x65, 0x79, 0x54,
	...
	,
}
...
var file_xchange_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_xchange_proto_goTypes = []interface{}{
	(*RekeyTrigger)(nil),           // 0: rekey.RekeyTrigger
	(*RekeyTriggerLegacySIDH)(nil), // 1: rekey.RekeyTriggerLegacySIDH
	(*RekeyConfirm)(nil),           // 2: rekey.RekeyConfirm
}
...
func file_xchange_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_xchange_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RekeyTriggerLegacySIDH); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
